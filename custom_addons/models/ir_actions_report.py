...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf(self,report_ref,res_ids=None,data=None):
        ...
        if report_ref in ('custom_addons.contract_template_raw', 'custom_addons.tta_raw'):
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if self._get_report(report_ref).report_name != 'custom_addons.contract_template_raw':
            return result
