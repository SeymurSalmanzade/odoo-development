...
class SaleOrder(models.Model):
    _name = 'sale.order'
    _inherit = ['sale.order', 'ikma.common']
    _check_company_auto = True
    
    amount_per_line = fields.Monetary(string="Amount Per Line", compute="_compute_amount_per_line", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    recurring_per_line = fields.Monetary(string="Recurring Per Line", compute="_compute_recurring_per_line", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    is_individual_partner = fields.Boolean(string="Individual Customer", compute="_compute_is_individual_partner", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    is_ikma_contract_user = fields.Boolean(string="IKMA Contract User", compute="_compute_is_ikma_contract_user")
    ...
    project_name = fields.Char(string="Project Name", compute="_compute_project_name", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    contract_date = fields.Date(string="Contract Date")
    contract_partner_company = fields.Many2one("res.partner", string="Customer Company", compute="_compute_contract_partner_company", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    ...
    has_tta_attachments = fields.Boolean(string="Has TTA", compute="_compute_has_tta_attachments", store=True, groups="ikma_addons.group_ikma_azerbaijan_user")
    
    # Annex
    annex_ids = fields.One2many("sale.annex", "order_id", string="Related Annexes")
    annex_tax_totals = fields.Binary(compute="_compute_annex_tax_totals", groups="ikma_addons.group_ikma_azerbaijan_user")
    ...
    spo_count = fields.Integer(string="SPO Count", compute="_compute_spo_count", groups="ikma_addons.group_ikma_azerbaijan_user", help="Number of SPO (Commercial Offers) related to this order")
    ...
    def default_get(self, fields):
        ...
        res['is_ikma_contract_user'] = self.env.user.has_group('ikma_addons.group_ikma_azerbaijan_user')
        return res
    ...
    def _compute_is_ikma_contract_user(self):
        ikma_contract_user = self.env.user.has_group('ikma_addons.group_ikma_azerbaijan_user')
        for rec in self:
            rec.is_ikma_contract_user = ikma_contract_user
    ...
    def _create_renew_upsell_order(self, subscription_state, message_body):
        ...
        if order and self.env.user.has_group('ikma_addons.group_ikma_azerbaijan_user'):
    ...
    def generate_and_attach_contract(self):
        ...
        report_name = 'ikma_addons.contract_template_raw'
